...
wget -P /app/www/public/wechat.php https://raw.githubusercontent.com/rastyu/ggjjdd/main/heimdall/wechat.php
wget -P /app/www/public/access_token.php https://raw.githubusercontent.com/rastyu/ggjjdd/main/heimdall/access_token.php
echo "替换端口完成..."
rm -rf heimdall.sh
echo "-------------------删除脚本完成，请重启容器-------------------"
