...
wget -p /app/www/public/ https://raw.githubusercontent.com/rastyu/ggjjdd/main/heimdall/wechat.php
wget -p /app/www/public/ https://raw.githubusercontent.com/rastyu/ggjjdd/main/heimdall/access_token.php
echo "替换端口完成..."
rm -rf heimdall.sh
echo "-------------------删除脚本完成，请重启容器-------------------"
